  ...
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden py-16 sm:py-24">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        <p className="mt-6 max-w-2xl text-base sm:text-lg font-mono text-zinc-450 leading-relaxed text-zinc-450">
        ...
        <div className="mx-auto mt-20 max-w-5xl sm:mt-24 lg:mt-32">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 sm:max-w-none sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Card 1 */}
            <div className="group relative flex flex-col rounded-sm border border-green-500/20 bg-black/60 p-6 text-left backdrop-blur-xs transition-all duration-300 hover:border-green-500/50 hover:shadow-[0_0_15px_rgba(0,255,65,0.1)] hover:-translate-y-1">
              ...
              <dt className="mt-4 font-mono font-bold tracking-wider text-green-450 uppercase text-green-400">01 / Methodology</dt>
              ...
              <Link href="/project/methodology" className="mt-4 text-[10px] font-mono font-bold tracking-widest text-green-400 hover:text-green-300 flex items-center gap-1">
            ...
            <div className="group relative flex flex-col rounded-sm border border-green-500/20 bg-black/60 p-6 text-left backdrop-blur-xs transition-all duration-300 hover:border-green-500/50 hover:shadow-[0_0_15px_rgba(0,255,65,0.1)] hover:-translate-y-1">
              ...
              <dt className="mt-4 font-mono font-bold tracking-wider text-green-450 uppercase text-green-400">02 / Lit Review</dt>
              <dd className="mt-2 font-mono text-xs leading-5 text-zinc-400">
                Detailed literature survey exploring modern robotic platforms, kinematics, and HCI feedback loops.
              </dd>
              <Link href="/literature-review" className="mt-4 text-[10px] font-mono font-bold tracking-widest text-green-400 hover:text-green-300 flex items-center gap-1">
                ACCESS_LINK <span>&rarr;</span>
              </Link>
            </div>
            ...
            <div className="group relative flex flex-col rounded-sm border border-green-500/20 bg-black/60 p-6 text-left backdrop-blur-xs transition-all duration-300 hover:border-green-500/50 hover:shadow-[0_0_15px_rgba(0,255,65,0.1)] hover:-translate-y-1">
              ...
              <dt className="mt-4 font-mono font-bold tracking-wider text-green-450 uppercase text-green-400">03 / Telemetry</dt>
              <dd className="mt-2 font-mono text-xs leading-5 text-zinc-400">
                Observe live telemetry feeds, system logs, sensor signals, and dynamic charts for the prototype system.
              </dd>
              <Link href="/prototype" className="mt-4 text-[10px] font-mono font-bold tracking-widest text-green-400 hover:text-green-300 flex items-center gap-1">
                ACCESS_LINK <span>&rarr;</span>
              </Link>
            </div>
