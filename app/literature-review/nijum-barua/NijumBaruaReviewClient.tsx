...
interface NijumBaruaReviewClientProps {
  papers: Paper[];
}

export default function NijumBaruaReviewClient({ papers }: NijumBaruaReviewClientProps) {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center mb-16">
          ...
          <h1 className="text-3xl font-extrabold tracking-wider sm:text-5xl font-mono uppercase text-white">
            // LIT_REVIEW: NIJUM_BARUA
          </h1>
          <p className="mt-4 font-mono text-sm text-zinc-400">
            Embedded Systems & Hardware Integration lead research database. Exploring Human-Robot Interaction (HRI), Conversational AI, and Autonomous Navigation frameworks.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-16 rounded-sm border border-green-500/20 bg-green-950/5 p-6 backdrop-blur-md">
          <div className="flex gap-3 items-start">
            ...
            <div className="font-mono">
              <h4 className="text-xs font-bold uppercase tracking-wider text-green-400">Critical Synthesis Context</h4>
              <p className="mt-2 text-xs text-zinc-400 leading-relaxed">
                The analyzed literature focuses primarily on friendly, service-oriented robots (museum guides, library aids, storytelling devices) operating in highly controlled, safe human environments. In contrast, **Project Aegis** transposes these capabilities (local voice processing, sensor fusion, SLAM navigation) into a secure, tactical combat framework operating autonomously in network-denied, dangerous territories.
              </p>
            </div>
          </div>
        </div>
