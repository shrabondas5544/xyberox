...
interface SMMahadiBhuiyanReviewClientProps {
  papers: Paper[];
}

export default function SMMahadiBhuiyanReviewClient({ papers }: SMMahadiBhuiyanReviewClientProps) {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center mb-16">
          ...
          <h1 className="text-3xl font-extrabold tracking-wider sm:text-5xl font-mono uppercase text-white">
            // LIT_REVIEW: SM_MAHADI_BHUIYAN
          </h1>
          <p className="mt-4 font-mono text-sm text-zinc-400">
            Computer Vision & Perception lead research database. Exploring Human-Robot Interaction (HRI), Cross-Cultural Design, and Collaborative Robotic Control systems.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-16 rounded-sm border border-green-500/20 bg-green-950/5 p-6 backdrop-blur-md">
          <div className="flex gap-3 items-start">
            ...
            <div className="font-mono">
              <h4 className="text-xs font-bold uppercase tracking-wider text-green-400">Perception & Interaction Context</h4>
              <p className="mt-2 text-xs text-zinc-400 leading-relaxed">
                The analyzed literature explores collaborative art rendering, cross-cultural greeting behaviors, and low-cost educational speech platforms. **Project Aegis** adapts these core vision and interface principles—harnessing precision coordinate mapping, local natural language handshakes, and user behavior metrics—to build a stealth-focused, autonomous navigation and target-detection intelligence system.
              </p>
            </div>
          </div>
        </div>
                      ...
                      <div className="space-y-4">
                        ...
                        {paper.description && (
                          <div>
                            ...
                            <p className="text-zinc-400 leading-relaxed">{paper.description}</p>
                          </div>
                        )}
                      </div>
                          ...
                          <div className="space-y-2.5">
                            {paper.questions.map((rq, i) => (
                              <div key={i} className="bg-green-950/10 border border-green-500/10 p-2.5 rounded-sm">
                                ...
                                <p className="text-zinc-400 leading-relaxed">{rq.substring(5)}</p>
                              </div>
                            ))}
                          </div>
                        </div>
